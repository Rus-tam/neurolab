...
sweet_gas_mol_weight_model_path = os.path.abspath('./models/amine_treatment/sweet_gas_mol_weight_model.h5')
rich_amine_mol_weight_path = os.path.abspath('./models/amine_treatment/rich_amine_mol_weight_model.h5')
...
sweet_gas_mol_weight_model = tf.keras.models.load_model(sweet_gas_mol_weight_model_path)
rich_amine_mol_weight_model = tf.keras.models.load_model(rich_amine_mol_weight_path)
