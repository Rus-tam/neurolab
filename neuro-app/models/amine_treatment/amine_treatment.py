...
amine_treatment_rich_amine_mol_flow_path = os.path.abspath('models/amine_treatment/amine_treatment_rich_amine_sour_molar_flow_model.h5')
...
amine_treatment_rich_amine_mol_flow_model = tf.keras.models.load_model(amine_treatment_rich_amine_mol_flow_path)
