...
def amine_treatment(dto: AmineTreatmentInitial):
    ...
    return {
    'feed_gas_mol_weight': round(initial_data['feed_gas molecular weight'][0], 4),
    'lean_amine_mol_weight': round(initial_data['lean_amine molecular weight'][0], 4),
    'feed_gas_mass_density': round(initial_data['feed_gas Mass density, kg/m3'][0], 4),
    'lean_amine_mass_density': round(initial_data['lean_amine Mass density, kg/m3'][0], 4),
    'sweet_gas_temperature': round(initial_data['sweet_gas temperature, C'][0], 4),
    'sweet_gas_mol_flow': round(initial_data['sweet_gas molar flow, kgmol/h'][0], 4),
    'rich_amine_mol_flow': round(initial_data['rich_amine molar flow, kgmol/h'][0], 4),
    'rich_amine_temperature': round(initial_data['rich_amine temperature, C'][0], 4),
    'rich_amine_h2s_mol_flow': round(initial_data['rich_amine H2S molar flow, kgmol/h'][0], 4),
    'sweet_gas_h2s_mol_flow': round(initial_data['sweet_gas H2S molar flow, kgmol/h'][0], 4),
    'rich_amine_co2_mol_flow': round(initial_data['rich_amine CO2 molar flow, kgmol/h'][0], 4),
    'sweet_gas_co2_mol_flow': round(initial_data['sweet_gas CO2 molar flow, kgmol/h'][0], 4),
    'sweet_gas_mol_weight': round(initial_data['sweet_gas molecular weight'][0], 4),
    'rich_amine_mol_weight': round(initial_data['rich_amine molecular weight'][0], 4)
    }
