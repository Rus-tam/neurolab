...
amine_treatment_prod_molar_weight_path = os.path.abspath('data/amine_treatment/molar_weight_data.csv')
...
amine_treatment_prod_molar_weight_data = pd.read_csv(amine_treatment_prod_molar_weight_path)
