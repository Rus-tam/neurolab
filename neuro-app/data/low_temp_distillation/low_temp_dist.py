...
sep_prod_vol_flow_data_path = os.path.abspath('data/low_temp_distillation/sep_prod_vol_flow_data.csv')
...
sep_prod_vol_flow_data = pd.read_csv(sep_prod_vol_flow_data_path)
