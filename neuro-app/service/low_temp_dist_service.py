...
def separator_prod_mass_flow(dto: LowTempDistInitial, feed_gas_comp_mass_flow):
    data = prepare_low_temp_data(dto)
    initial_data = pd.DataFrame({
        **data,
        'gas_feed Methane mass flow, kg/h': feed_gas_comp_mass_flow['gas_feed Methane mass flow, kg/h'],
    ...
    columns = [*column, 'gas_feed Methane mass flow, kg/h',
               'gas_feed Ethane mass flow, kg/h', 'gas_feed Propane mass flow, kg/h',
               'gas_feed i-Butane mass flow, kg/h', 'gas_feed n-Butane mass flow, kg/h',
               'gas_feed i-Pentane mass flow, kg/h', 'gas_feed n-Pentane mass flow, kg/h',
               'gas_feed actual liquid flow, m3/h', 'gas_feed actual vapour flow, m3/h'
               ]
