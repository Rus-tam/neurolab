...
from models.amine_treatment.amine_treatment import rich_amine_CO2_molar_flow_model, sweet_gas_mol_weight_model
from models.amine_treatment.amine_treatment import rich_amine_mol_weight_model
...
def sweet_gas_mol_weight_prediction(initial_data):
    sweet_gas_mol_weight_data = initial_data[[
    'feed_gas temperature, C', 'feed_gas mass flow, kg/h', 'feed_gas CO2 mol frac', 'feed_gas Methane mol frac',
    'feed_gas Ethane mol frac', 'feed_gas Propane mol frac', 'feed_gas i-Butane mol frac', 'feed_gas n-Butane mol frac',
    'feed_gas i-Pentane mol frac', 'feed_gas n-Pentane mol frac', 'feed_gas H2S mol frac', 'feed_gas H2O mol frac',
    'feed_gas MDEAmine mol frac',
    ...
    sweet_gas_mol_weight_transformers = joblib.load('./transformers/amine_treatment/sweet_gas_mol_weight_transformer.pkl')
    sweet_gas_mol_weight_norm_data = sweet_gas_mol_weight_transformers.transform(sweet_gas_mol_weight_data)
    sweet_gas_mol_weight = sweet_gas_mol_weight_model(sweet_gas_mol_weight_norm_data).numpy().tolist()

    return sweet_gas_mol_weight[0]


def rich_amine_mol_weight_prediction(initial_data):
    rich_amine_mol_weight_data = initial_data[[
    'feed_gas temperature, C', 'feed_gas mass flow, kg/h', 'feed_gas CO2 mol frac', 'feed_gas Methane mol frac',
    'feed_gas Ethane mol frac', 'feed_gas Propane mol frac', 'feed_gas i-Butane mol frac', 'feed_gas n-Butane mol frac',
    'feed_gas i-Pentane mol frac', 'feed_gas n-Pentane mol frac', 'feed_gas H2S mol frac', 'feed_gas H2O mol frac',
    'feed_gas MDEAmine mol frac',
    ...
    'lean_amine MDEAmine molar flow, kgmol/h', 'lean_amine molecular weight', 'lean_amine Mass density, kg/m3',
    'sweet_gas molar flow, kgmol/h',
    'sweet_gas temperature, C', 'rich_amine molar flow, kgmol/h', 'sweet_gas molecular weight',
    ]]

    rich_amine_mol_weigh_transform = joblib.load('./transformers/amine_treatment/rich_amine_mol_weight_transformer.pkl')
    rich_amine_mol_weight_norm_data = rich_amine_mol_weigh_transform.transform(rich_amine_mol_weight_data)
    rich_amine_mol_weight = rich_amine_mol_weight_model(rich_amine_mol_weight_norm_data).numpy().tolist()

    return rich_amine_mol_weight[0]