...
export class DbService {
  ...
  async createAmineTreatmentNote(
    ...
    const newEntry = this.amineTreatmentResRepository.create({
      ...initialData,
      feed_gas_molecular_weight: result['feed_gas molecular weight'],
      lean_amine_molecular_weight: result['lean_amine molecular weight'],
      feed_gas_mass_density: result['feed_gas Mass density, kg/m3'],
      lean_amine_mass_density: result['lean_amine Mass density, kg/m3'],
      sweet_gas_temperature: result['sweet_gas temperature, C'],
      sweet_gas_molar_flow: result['sweet_gas molar flow, kgmole/h'],
      rich_amine_molar_flow: result['rich_amine molar flow, kgmole/h'],
      rich_amine_temperature: result['rich_amine temperature, C'],
      rich_amine_h2s_molar_flow: result['rich_amine H2S molar flow, kgmole/h'],
      sweet_gas_h2s_molar_flow: result['sweet_gas H2S molar flow, kgmole/h'],
      rich_amine_co2_molar_flow: result['rich_amine CO2 molar flow, kgmole/h'],
      sweet_gas_co2_molar_flow: result['sweet_gas CO2 molar flow, kgmole/h'],
      sweet_gas_molar_weight: result['sweet_gas molecular weight'],
      rich_amine_molar_weight: result['rich_amine molecular weight'],
