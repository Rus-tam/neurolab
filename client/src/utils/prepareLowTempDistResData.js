...
export const prepareColProdData = (data) => {
  if (data) {
    return {
      ...
      "Массовая доля диоксида углерода в парах верха колонны К-1": data.table_col_top_co2,
      "Массовая доля азота в парах верха колонны К-1": data.table_col_top_n2,
      ...
      "Массовая доля пропана в парах верха колонны К-1": data.table_col_top_c3h8,
      "Массовая доля и-бутана в парах верха колонны К-1": data.table_col_top_ic4h10,
      "Массовая доля н-бутана в парах верха колонны К-1": data.table_col_top_nc4h10,
      "Массовая доля и-пентана в парах верха колонны К-1": data.table_col_top_ic5h12,
      "Массовая доля н-пентана в парах верха колонны К-1": data.table_col_top_nc5h12,
      "Массовая доля диоксида углерода в жидкости низа колонны К-1": data.table_col_bot_co2,
      "Массовая доля азота в жидкости низа колонны К-1": data.table_col_bot_n2,
